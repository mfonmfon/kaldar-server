...
public class DiscoveryController {
    ...
    public ResponseEntity<ApiResponse<Page<AvailableDryCleanerResponse>>> findAvailableDryCleaners(@Valid @ModelAttribute FindAvailableDrycleanersRequest request
    ) {
