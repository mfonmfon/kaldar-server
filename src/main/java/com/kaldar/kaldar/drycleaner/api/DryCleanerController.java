...
public class DryCleanerController {
         ...
         * - "data" : JSON with businessName, businessType, registrationNumber,
         * taxIdentificationNumber, dryCleanerId
         * - "cacDocument" : The actual CAC certificate file (PDF / JPG / PNG, max 10
         * MB)
         */
        ...
        public ResponseEntity<ApiResponse<VerifyBusinessResponse>> verifyBusiness(
                ...
                VerifyBusinessResponse response = businessVerificationService.submitBusinessVerification(request,
                                cacDocumentUrl);
        ...
        public ResponseEntity<ApiResponse<java.util.List<com.kaldar.kaldar.drycleaner.application.dto.response.ServiceOfferingResponse>>> getServices(
                        @PathVariable Long dryCleanerId) {
                java.util.List<com.kaldar.kaldar.drycleaner.application.dto.response.ServiceOfferingResponse> response = dryCleanerService
                                .getServices(dryCleanerId);
        ...
        public ResponseEntity<ApiResponse<com.kaldar.kaldar.drycleaner.application.dto.response.ServiceOfferingResponse>> addOrUpdateService(
                ...
                com.kaldar.kaldar.drycleaner.application.dto.response.ServiceOfferingResponse response = dryCleanerService
                                .addOrUpdateService(dryCleanerId, request);
        ...
        public ResponseEntity<ApiResponse<com.kaldar.kaldar.drycleaner.application.dto.response.OnboardingStatusResponse>> getOnboardingStatus(
                        @PathVariable Long dryCleanerId) {
                com.kaldar.kaldar.drycleaner.application.dto.response.OnboardingStatusResponse response = dryCleanerService
                                .getOnboardingStatus(dryCleanerId);
        ...
        public ResponseEntity<ApiResponse<com.kaldar.kaldar.drycleaner.application.dto.response.AnalyticsResponse>> getAnalytics(
                ...
                com.kaldar.kaldar.drycleaner.application.dto.response.AnalyticsResponse response = dryCleanerService
                                .getAnalytics(dryCleanerId, period);
